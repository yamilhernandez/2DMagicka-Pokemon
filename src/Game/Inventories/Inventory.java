...
public class Inventory {
	...
	private void renderItems(Graphics g) {
		...
		if (inventoryItems.size() == 1) {
			g.drawImage(inventoryItems.get(0).getTexture(), 25, 24, inventoryItems.get(0).getWidth(),
			...
			g.drawImage(inventoryItems.get(0).getTexture(), 25, 24, inventoryItems.get(0).getWidth(),
					inventoryItems.get(0).getHeight(), null);
			g.drawString(String.valueOf(inventoryItems.get(0).getCount()), 25 + 33, 25 + 35);
			g.drawImage(inventoryItems.get(1).getTexture(), 86, 24, inventoryItems.get(1).getWidth(),
			...
			g.drawImage(inventoryItems.get(1).getTexture(), 86, 24, inventoryItems.get(1).getWidth(),
					inventoryItems.get(1).getHeight(), null);
			g.drawString(String.valueOf(inventoryItems.get(1).getCount()), 86 + 33, 24 + 35);
			g.drawImage(inventoryItems.get(2).getTexture(), 147, 24, inventoryItems.get(2).getWidth(),
			...
			g.drawImage(inventoryItems.get(2).getTexture(), 147, 24, inventoryItems.get(2).getWidth(),
					inventoryItems.get(2).getHeight(), null);
			g.drawString(String.valueOf(inventoryItems.get(2).getCount()), 147 + 33, 24 + 35);
			g.drawImage(inventoryItems.get(3).getTexture(), 208, 24, inventoryItems.get(2).getWidth(),
			...
			g.drawImage(inventoryItems.get(2).getTexture(), 147, 24, inventoryItems.get(2).getWidth(),
					inventoryItems.get(2).getHeight(), null);
			g.drawString(String.valueOf(inventoryItems.get(2).getCount()), 147 + 33, 24 + 35);
			g.drawImage(inventoryItems.get(3).getTexture(), 208, 24, inventoryItems.get(3).getWidth(),
					inventoryItems.get(3).getHeight(), null);
			g.drawString(String.valueOf(inventoryItems.get(3).getCount()), 208 + 33, 24 + 35);
			/////////
			g.drawImage(inventoryItems.get(4).getTexture(), 269, 24, inventoryItems.get(4).getWidth(),
			...
			g.drawImage(inventoryItems.get(4).getTexture(), 269, 24, inventoryItems.get(4).getWidth(),
					inventoryItems.get(4).getHeight(), null);
			g.drawString(String.valueOf(inventoryItems.get(4).getCount()), 269 + 33, 24 + 35);
			g.drawImage(inventoryItems.get(5).getTexture(), 20, 78, inventoryItems.get(4).getWidth()+10,
						inventoryItems.get(5).getHeight()+10, null);
			g.drawString(String.valueOf(inventoryItems.get(5).getCount()), 25 + 33, 87 + 35);
				...
				g.drawImage(inventoryItems.get(5).getTexture(), 20, 78, inventoryItems.get(4).getWidth()+10,
							inventoryItems.get(5).getHeight()+10, null);
				g.drawString(String.valueOf(inventoryItems.get(5).getCount()), 25 + 33, 87 + 35);
				g.drawImage(inventoryItems.get(6).getTexture(), 82, 78, inventoryItems.get(4).getWidth()+10,
						inventoryItems.get(6).getHeight()+10, null);
				g.drawString(String.valueOf(inventoryItems.get(6).getCount()), 86 + 33, 87 + 35);
