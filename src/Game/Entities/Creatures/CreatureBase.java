...
public abstract class CreatureBase extends EntityBase {
	...
	protected static final int DEFAULT_BOSS_WIDTH= 300, DEFAULT_BOSS_HEIGHT= 300;
	...
	public BufferedImage getCurrentAnimationFrame(Animation animDown, Animation animUp, Animation animLeft,
			Animation animRight, BufferedImage[] front, BufferedImage[] back, BufferedImage[] left,
			BufferedImage[] right) {
		if (xMove < 0) {
			ll = true;
			ld = false;
