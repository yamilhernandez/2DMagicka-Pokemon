...
public class Rock extends StaticEntity {
	...
	public void render(Graphics g) {
		renderLife(g);
		g.drawImage(Images.blocks[14], (int) (x - handler.getGameCamera().getxOffset()),
	...
	public void die() {
		...
		if (RNGR == 1) {
			handler.getWorld().getItemManager()
					.addItem(Item.fireRuneItem.createNew((int) x + bounds.x + (randint.nextInt(32) - 32),
							(int) y + bounds.y + (randint.nextInt(32) - 32), (randint.nextInt(3) + 1)));
		}
